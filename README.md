...
**功能描述**：分析月度工作日报Excel文件，按目标名称统计总工时，提取并归纳主要工作内容。输出可复制的纯文本统计表，包含目标名称、工时数、占比，以及归纳为4-5条的主要工作内容。

**适用场景**：月度工作汇总、周报/月报工时统计。

**核心特性**：
- 自动读取日报Excel，按目标名称分组统计
- 计算各目标工时占比
- 提取工作内容，归纳为4-5条关键要点
- 输出可复制格式（使用圈号序号①②③④⑤）
- 保存为txt文件便于直接使用

**触发词**：工时汇总、月度工时、工作统计、日报分析

**详细文档**：见 [monthly-workhours-summary/SKILL.md](./monthly-workhours-summary/SKILL.md)
